...
- **SBM (Supply & Borrow Market)** — supply TRX or TRC20 assets to earn interest; over-collateralize one asset to borrow another. **17 active + 6 legacy = 23 jToken markets** on TRON Mainnet ([authoritative list](developers/apis.md#2-jtoken-address-reference)).
...
- **GitHub:** [protocol](https://github.com/justlend/justlend-protocol) · [MCP server](https://github.com/justlend/mcp-server-justlend) · [Skills](https://github.com/justlend/justlend-skills) · [these docs](https://github.com/justlend/justlend-docs)
